...
var ASM_CONSTS = {
 ...
 774456: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 774539: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 774608: () => { return window.innerWidth; },  
 774638: () => { return window.innerHeight; }
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 500800;
